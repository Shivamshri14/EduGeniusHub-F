...
export const TOOLS: Tool[] = [
  ...
  },
  {
    ...
    description: "Advanced grammar, clarity and academic writing assistance.",
  ...
  },
  {
    id: "jenni-ai",
    name: "Jenni AI",
    tagline: "AI-powered academic writing assistant.",
    description: "Write essays, research papers and content with AI help.",
  ...
  },
  {
    ...
    description: "1 year premium access on customer mobile number (5 screens).",
  ...
  {
    id: "sonyliv-premium",
    name: "SonyLiv Premium (1 Year / 5 Screens)",
    tagline: "Live sports, originals & shows.",
    description: "1 year premium access on customer mobile number (5 screens).",
