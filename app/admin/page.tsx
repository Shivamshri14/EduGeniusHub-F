      ...
      <div className="bg-white dark:bg-slate-800 border-b border-slate-200 dark:border-slate-700 sticky top-0 z-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              <a
                href={process.env.NEXT_PUBLIC_SANITY_PROJECT_ID ? `https://${process.env.NEXT_PUBLIC_SANITY_PROJECT_ID}.sanity.studio` : "https://www.sanity.io/manage"}
                target="_blank"
              ...
              >
                ...
                <span className="hidden sm:inline">Manage Tools in Sanity</span>
                <span className="sm:hidden">Sanity</span>
              </a>
              <button
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="bg-blue-50 dark:bg-blue-900/20 border-l-4 border-blue-600 p-4 mb-8 rounded-r-lg">
          <p className="text-sm text-blue-900 dark:text-blue-100">
            <strong>Note:</strong> Tools and Combos are now managed in Sanity Studio. Click the "Manage Tools in Sanity" button above to add/edit tools and combo packages.
          </p>
        </div>
