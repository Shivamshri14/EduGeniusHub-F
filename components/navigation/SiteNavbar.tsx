...
export default function SiteNavbar() {
  ...
  return (
    ...
    >
      <div className="max-w-6xl mx-auto px-4 h-16 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          <a
            ...
            className="hidden md:flex items-center gap-2 bg-[#25D366] hover:bg-[#1ebe5d] text-white text-sm font-semibold px-4 py-2 rounded-xl transition-colors"
          >
      ...
      {open && (
        <div className="md:hidden bg-background/98 backdrop-blur-md border-b border-border px-4 pb-4 pt-2">
          {navLinks.map((link) => (
            <Link
              key={link.href}
              href={link.href}
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-2 bg-[#25D366] text-white text-sm font-semibold px-4 py-3 rounded-xl mt-2 justify-center"
          >
            Chat on WhatsApp
          </a>
        </div>
